...
// CONCATENATED MODULE: ./src/components/Sprite.js
...
function () {
  function Sprite(_ref) {
    ...
    this.tl = new TimelineMax_TimelineMax({
      paused: true,
  ...
  _createClass(Sprite, [{
    ...
    key: "stopAtEnd",
    value: function stopAtEnd() {
      this.shouldStop = true;
    }
  }, {
    key: "checkShouldStop",
    value: function checkShouldStop() {
      if (this.shouldStop) {
        this.pause();
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Sprite", function() { return src_Sprite; });
 // import SpriteVueComponent from './components/Sprite.vue';

var src_Sprite = components_Sprite; // export const SpriteVue = SpriteVueComponent;

/* harmony default export */ var src = __webpack_exports__["default"] = ({
  Sprite: src_Sprite // SpriteVue,
