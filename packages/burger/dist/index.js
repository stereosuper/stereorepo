(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("Burger", [], factory);
	else if(typeof exports === 'object')
		exports["Burger"] = factory();
	else
		root["Burger"] = factory();
})(window, function() {
...
function () {
  function Burger(_ref) {
    var _ref$burgerSelector = _ref.burgerSelector,
        burgerSelector = _ref$burgerSelector === void 0 ? '.js-burger' : _ref$burgerSelector,
        _ref$mainNavigationSe = _ref.mainNavigationSelector,
        mainNavigationSelector = _ref$mainNavigationSe === void 0 ? '.js-main-navigation' : _ref$mainNavigationSe;
  ...
  _createClass(Burger, [{
    key: "toggleNoScroll",
    value: function toggleNoScroll(_ref2) {
      var transitionElement = _ref2.transitionElement,
      ...
      if (noScroll) {
        if (!this.transitionElementDuration || this.transitionElementDuration === '0s') {
          this.transitionElementDuration = getComputedStyle(transitionElement).getPropertyValue('transition-duration');
        }
    ...
    key: "makeTheDamnBurger",
    value: function makeTheDamnBurger() {
      this.state.burgerActivated = !this.state.burgerActivated;

      var _query = Object(dist["query"])({
        selector: this.mainNavigationSelector
      }),
          _query2 = _slicedToArray(_query, 1),
          mainNav = _query2[0];
    ...
    key: "thisBurgerIsTooFat",
    value: function thisBurgerIsTooFat() {
      if (dist["superWindow"].currentBreakpoint === 'xl' && this.state.burgerActivated) {
        this.makeTheDamnBurger();
      }
    }
  }, {
    key: "bigMacOrWhopper",
    value: function bigMacOrWhopper() {
      var _this = this;

      var _query3 = Object(dist["query"])({
        selector: this.burgerSelector
      }),
      ...
      burger.addEventListener('click', function () {
        _this.makeTheDamnBurger();
      }, false);
      dist["superWindow"].addResizeFunction(this.thisBurgerIsTooFat);
    }
  }]);
...
/* harmony default export */ var components_Burger = (Burger_Burger);
// CONCATENATED MODULE: ./src/index.js
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Burger", function() { return src_Burger; });

var src_Burger = components_Burger;
/* harmony default export */ var src = __webpack_exports__["default"] = ({
  Burger: src_Burger
});
